        ...
        <div class="layui-card-header layuiadmin-card-header-auto">
            <div class="layui-btn-group ">
                ...
                @can('system.permission.create')
                    <a class="layui-btn layui-btn-sm" onclick="active.openLayerCustomForm('{{route('admin.permission.create')}}','添加权限','88%','50%');">添 加</a>
                @endcan
            ...
            layui.use(['layer', 'table', 'form'], function () {
                ...
                var dataTable = table.render({
                    ...
                    , cols: [[ //表头
                        ...
                        , {field: 'icon_id', title: '图标', templet: '#icon'}
                        , {field: 'created_at', title: '创建时间'}
                        , {field: 'updated_at', title: '更新时间'}
                        , {fixed: 'right', width: 160, title: '操作', align: 'center', toolbar: '#options'}
                    ]]
                });
                ...
                table.on('tool(dataTable)', function (obj) { //注：tool是工具条事件名，dataTable是table原始容器的属性 lay-filter="对应的值"
                    ...
                    if (layEvent === 'del') {
                        ...
                        active.openLayerCustomForm('/admin/permission/' + data.id + '/edit', '编辑权限', '88%', '50%');
